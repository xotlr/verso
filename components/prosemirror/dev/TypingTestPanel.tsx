...
export function TypingTestPanel({ view }: TypingTestPanelProps) {
      ...
      if (testType === 'burst') {
        ...
        testResult = await runTypingTest(
          ...
          testElements,
          {
            ...
            mode: testType === 'stress' ? 'standard' : 'standard',
          },
          setProgress
        );
      }
  ...
  return (
    <div className="fixed bottom-20 right-4 z-50 w-96 bg-background border border-border rounded-lg shadow-xl overflow-hidden">
      {/* Header */}
